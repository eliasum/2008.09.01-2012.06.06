...
#define NTP          6                     // базовый адрес тензопреобразовател€
#define NDUN         4                     // базовый адрес датчика угла наклона
#define T_LED_ON     (SYSTEM_TICK/5)       // врем€ индикации обращени€ к датчику

#define AUX_ADC      0x09                  // регистр данных ј÷ѕ
...
#define RST   PORTB1                       // вывод управлени€ сбросом "ведомого"          OUT (1)
...
#define SET_  PIND2                        // вывод входа конфигурации установок           IN  (^)
#define TST   PORTD3                       // вывод управлени€ термостатом                 OUT (0)
#define S1    PIND4                        // вывод наличи€ или отсутстви€ перемычки –1    IN  (^)
#define S2    PIND5                        // вывод наличи€ или отсутстви€ перемычки –2    IN  (^)
#define S3    PIND6                        // вывод наличи€ или отсутстви€ перемычки –3    IN  (^)
#define DAC0  PORTD7                       // вывод управлени€ питанием моста              OUT (0)
