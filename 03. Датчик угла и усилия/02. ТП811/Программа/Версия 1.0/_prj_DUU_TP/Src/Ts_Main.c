/********************************************************************************/
/*                                                                              */
/*                       Управляющая программа для ТП811                        */
/*                           Версия 1.0 (2011.04.08)                            */
/*                                                                              */
/********************************************************************************/
#include "ts_main.h"
/*==============================================================================*/
...
/*==============================================================================*/
  ...
  unsigned char rcom;           // принятая "команда"
/*==============================================================================*/
/*                                                                              */
...
// Конфигурация ЦАП
  ...
  byte_ndv = P3;                        // YYYX XXYY фиксация перемычки "номер устройства"
  byte_ndv >>= 2;                       // YYYY YXXX
  byte_ndv &= 0x07;                     // 0000 0XXX
  byte_ndv += NDEV;                     // + база
