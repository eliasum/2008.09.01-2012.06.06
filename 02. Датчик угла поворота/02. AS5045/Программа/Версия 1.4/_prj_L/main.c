...
//////////////////////// Работа в режиме -= УСТАНОВКИ =- ///////////////////////
  if (!fl_set)
  {
    ...
    {            
      ...
      tick.du_c[2]=SPI_WriteRead(0);        // байт данных от AS5045 --> 'dddd dddd'
      tick.du_c[1]=SPI_WriteRead(0);        // байт данных от AS5045 --> 'dddd oclm'  
      tick.du_c[0]=SPI_WriteRead(0);        // байт данных от AS5045 --> 'mp-- ----'
/*      
