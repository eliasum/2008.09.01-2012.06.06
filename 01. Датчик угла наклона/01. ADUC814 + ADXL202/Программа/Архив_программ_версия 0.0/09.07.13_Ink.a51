...
; измерение длительности импульсов с выходов Xout и Yout

X_F:    JNB     XOUT,X_F        ; ожидание фронта импульса с выхода Xout      	
	    SETB    TR0             ; запуск T0
		
X_S:    JB      XOUT,X_S        ; ожидание спада импульса с выхода Xout
	  	CLR     TR0             ; останов T0                  
...
Y_F:    JNB     YOUT,Y_F        ; ожидание фронта импульса с выхода Yout      	
	    SETB    TR0             ; запуск T0
		
Y_S:    JB      YOUT,Y_S        ; ожидание спада импульса с выхода Yout
		CLR     TR0             ; останов T0                  

        MOV     A,TL0           ; в R3R2 - значение длительности импульсов с выхода Yout
        MOV     R2,A
        MOV     A,TH0
        MOV     R3,A
