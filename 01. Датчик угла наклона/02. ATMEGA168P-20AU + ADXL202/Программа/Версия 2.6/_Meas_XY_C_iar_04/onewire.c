...
void ow_set_bus(volatile unsigned char* in, volatile unsigned char* out, volatile unsigned char* ddr, unsigned char pin)
{
  OW_DDR=ddr;
  OW_OUT=out;
  OW_IN=in;
