...
//#define OW_ONE_BUS //
 ...
 #define OW_CONF_DELAYOFFSET ( (unsigned int)( ((OW_CONF_CYCLESPERACCESS)*1000000L) / F_CPU  ) )
#endif
...
extern void ow_set_bus(volatile unsigned char* in, volatile unsigned char* out, volatile unsigned char* ddr, unsigned char pin);
